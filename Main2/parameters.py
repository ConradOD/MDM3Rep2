class Parameters:
    def __init__(self,num_aircraft=10,grid_size=1000,delta_t=0.5,max_t=10,num_scenarios=10,separation_thresh_hor=5,separation_thresh_ver=5,vertical_offset=1000,velocity_mag=10,direction_variation=5,acceleration_rand = 1,correction_mag=1):

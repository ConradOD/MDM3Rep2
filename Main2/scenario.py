...
class Scenario:
    ...
    def generate_scenario(self):
        ...
        temp_vel = (self.direction + np.random.rand(self.Parameters.num_aircraft,3) * self.Parameters.direction_variation)
        self.initial_velocities = temp_vel / np.linalg.norm(temp_vel) * self.Parameters.velocity_mag
